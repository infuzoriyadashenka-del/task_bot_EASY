...
@router.message(
F.text.lower() == "аналитика"
)
async def analytics_text(
message: Message
):
...
task_text, executor, deadline = parse_task(
    message.text
)
